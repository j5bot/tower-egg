requirejs.config({
	paths: {
		"jquery": [ "http://ajax.googleapis.com/ajax/libs/jquery/1.9.1/jquery.min", "lib/jquery.min" ],
		"jquery-ui": [ "http://ajax.googleapis.com/ajax/libs/jqueryui/1.10.2/jquery-ui.min", "lib/jquery-ui.min" ],
		"tower": "tower.ug"
	}
});

define(["jquery","jquery-ui","tower"], (function () {
